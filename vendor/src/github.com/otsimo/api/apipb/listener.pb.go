...
type Event struct {
	...
	SubId string `protobuf:"bytes,4,opt,name=sub_id,proto3" json:"sub_id,omitempty"`
	// DeviceId is unique device identifier,
	DeviceId string `protobuf:"bytes,5,opt,name=device_id,proto3" json:"device_id,omitempty"`
	// Data is a json data
